...
BOOL CThemeUtil::OpenThemeData(HWND hWnd, LPCWSTR pszClassList)
{
	...
	{
		UINT(PASCAL* pfnOpenThemeData)(HWND hwnd, LPCWSTR);
...
BOOL CThemeUtil::DrawThemePart(HDC hdc, int iPartId, int iStateId, const RECT *pRect)
{
	if (m_hTheme == NULL)
		return FALSE;
	UINT(PASCAL* pfnDrawThemeBackground)(UINT hTheme, HDC , int , int ,
		const RECT *, const RECT* pClipRect);
...
BOOL CThemeUtil::GetThemeColor(int iPartId, int iStateId, int iPropId, const COLORREF *pColor)
{
	if (m_hTheme == NULL)
		return FALSE;
	UINT(PASCAL* pfnGetThemeColor)(UINT hTheme, int , int , int , const COLORREF *);
...
BOOL CThemeUtil::GetThemeEnumValue(int iPartId, int iStateId, int iPropId, const int *piVal)
{
	...
	UINT(PASCAL* pfnGetThemeEnumValue)(UINT hTheme, int , int , int ,
		const int *);
...
BOOL CThemeUtil::GetThemeInt(int iPartId, int iStateId, int iPropId, const int *piVal)
{
	...
	UINT(PASCAL* pfnGetThemeInt)(UINT hTheme, int , int , int ,
		const int *);
...
BOOL CThemeUtil::GetThemeMargins(int iPartId, int iStateId, int iPropId, const MY_MARGINS *pMargins)
{
	...
	UINT(PASCAL* pfnGetThemeMargins)(UINT hTheme, OPTIONAL HDC hdc, int ,
		int , int , OPTIONAL RECT *prc, const MY_MARGINS *);
	...
	OUT LPWSTR pszThemeFileName, int cchMaxBuffChars)
{
	if (m_hTheme == NULL)
		return FALSE;
	UINT(PASCAL* pfnGetThemeFilename)(UINT hTheme, int , int , int ,
		OUT LPWSTR , int );
	...
	OUT OPTIONAL LPWSTR pszSizeBuff, int cchMaxSizeChars)
{
	if (m_hUxThemeDll == NULL)
		return FALSE;
	UINT(PASCAL* pfnGetCurrentThemeName)(OUT LPWSTR ,
		int ,
		OUT OPTIONAL LPWSTR ,
		int ,
		OUT OPTIONAL LPWSTR ,
