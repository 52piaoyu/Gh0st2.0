#if !defined(AFX_MyFileManagerDLG_H__4918F922_13A4_4389_8027_5D4993A6DB91__INCLUDED_)
#define AFX_MyFileManagerDLG_H__4918F922_13A4_4389_8027_5D4993A6DB91__INCLUDED_
...
// MyFileManagerDlg.h : header file
//
...
class CMyFileManagerDlg : public CDialogEx
{
	// Construction
public:
	bool m_bIsStop;
	...
	CMyFileManagerDlg(CWnd* pParent = NULL, CIOCPServer* pIOCPServer = NULL, ClientContext *pContext = NULL);   // standard constructor

	// Dialog Data
	//{{AFX_DATA(CMyFileManagerDlg)
	enum { IDD = IDD_FILE };
...
protected:
	...
	afx_msg void OnRemotePackFile();
	afx_msg void OnRemoteUnpackFile();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
...
#endif // !defined(AFX_MyFileManagerDLG_H__4918F922_13A4_4389_8027_5D4993A6DB91__INCLUDED_)
