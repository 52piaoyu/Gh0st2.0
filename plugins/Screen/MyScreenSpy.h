// MyScreenSpy.h: interface for the CMyScreenSpy class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_MyScreenSpy_H__6600B30F_A7E3_49D4_9DE6_9C35E71CE3EE__INCLUDED_)
#define AFX_MyScreenSpy_H__6600B30F_A7E3_49D4_9DE6_9C35E71CE3EE__INCLUDED_
#include <windows.h>
...
{
public:
	CMyScreenSpy(int biBitCount= 8, bool bIsGray= false, UINT nMaxFrameRate = 100);
	virtual ~CMyScreenSpy();
	LPVOID getFirstScreen();
	LPBYTE getNextScreen(LPDWORD lpdwBytes);
...
#endif // !defined(AFX_MyScreenSpy_H__6600B30F_A7E3_49D4_9DE6_9C35E71CE3EE__INCLUDED_)
